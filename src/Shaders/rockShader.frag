...
void main(void)
{
    ...
    ground_material.ambiant = vec4(.2, .2, .2, 1.);
    ground_material.diffuse = vec4(.6, .6, .6, 1.);
    ground_material.ambiant = vec4(.1, .1, .1, 1.);
    ground_material.shininness = 5.;

    Material grass_material;
    ground_material.ambiant = vec4(.1, .5, .2, 1.);
