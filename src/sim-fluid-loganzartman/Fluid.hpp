...
struct Fluid {
    ...
    const int particle_density = 1;
    const int grid_size = 15;
    const glm::ivec3 grid_dimensions{grid_size*8 + 1, grid_size + 1, grid_size + 1};
    const glm::ivec3 grid_cell_dimensions{grid_size*8, grid_size, grid_size};
                ...
                for (int gx = 0; gx < grid_dimensions.x; ++gx) {
                    ...
                    if (gx > d.x / 2) {
                        ...
                        initial_grid.emplace_back(GridCell{
                            cell_pos,
                            glm::vec3(0),
                            GRID_SOLID // (gy > d.y / 2 ? GRID_SOLID : GRID_AIR)
                        });
                    }
                }
            }
...
//        ssf_b_texture.set_texture_size(w, h);
    ...
    void set_common_uniforms(gfx::Program& program) {
        GlobalsGL::f()->glUniform3fv(program.uniform_loc("bounds_min"), 1, glm::value_ptr(bounds_min));
        GlobalsGL::f()->glUniform3fv(program.uniform_loc("bounds_max"), 1, glm::value_ptr(bounds_max));
        GlobalsGL::f()->glUniform3iv(program.uniform_loc("grid_dim"), 1, glm::value_ptr(grid_dimensions));
        GlobalsGL::f()->glUniform2iv(program.uniform_loc("resolution"), 1, glm::value_ptr(resolution));
    }
    ...
    void reset_grid() {
        ...
        GlobalsGL::f()->glDispatchCompute(grid_dimensions.x, grid_dimensions.y, grid_dimensions.z);
        ...
        for (int x = 0; x < grid_dimensions.x; ++x) {
            for (int y = 0; y < grid_dimensions.y; ++y) {
                for (int z = 0; z < grid_dimensions.z; ++z) {
                    ...
                    grid[i].type = (grid[i].type == GRID_SOLID ? GRID_SOLID : (x < grid_cell_dimensions.x and y < grid_cell_dimensions.y and z < grid_cell_dimensions.z) ? GRID_AIR : GRID_SOLID);
    ...
    void particle_to_grid() {
        ...
        for (int i = 0; i < particle_ssbo.length() / group_size + 1; ++i) {
            GlobalsGL::f()->glUniform1i(p2g_accumulate_program.uniform_loc("start_index"), i * group_size);
            p2g_accumulate_program.validate();
            ssbo_barrier();
            GlobalsGL::f()->glDispatchCompute(1, 1, 1);
        } 
    ...
    void extrapolate() {
        ...
        GlobalsGL::f()->glUniform3fv(extrapolate_program.uniform_loc("bounds_min"), 1, glm::value_ptr(bounds_min));
        GlobalsGL::f()->glUniform3fv(extrapolate_program.uniform_loc("bounds_max"), 1, glm::value_ptr(bounds_max));
        GlobalsGL::f()->glUniform3iv(extrapolate_program.uniform_loc("grid_dim"), 1, glm::value_ptr(grid_dimensions));
        extrapolate_program.validate();
    
        set_vel_known_program.use();
        GlobalsGL::f()->glUniform3fv(set_vel_known_program.uniform_loc("bounds_min"), 1, glm::value_ptr(bounds_min));
        GlobalsGL::f()->glUniform3fv(set_vel_known_program.uniform_loc("bounds_max"), 1, glm::value_ptr(bounds_max));
        GlobalsGL::f()->glUniform3iv(set_vel_known_program.uniform_loc("grid_dim"), 1, glm::value_ptr(grid_dimensions));
    ...
    void apply_body_forces(float dt) {
        ...
        GlobalsGL::f()->glUniform1f(body_forces_program.uniform_loc("dt"), dt);
        GlobalsGL::f()->glUniform3fv(body_forces_program.uniform_loc("bounds_min"), 1, glm::value_ptr(bounds_min));
        GlobalsGL::f()->glUniform3fv(body_forces_program.uniform_loc("bounds_max"), 1, glm::value_ptr(bounds_max));
        GlobalsGL::f()->glUniform3iv(body_forces_program.uniform_loc("grid_dim"), 1, glm::value_ptr(grid_dimensions));
        GlobalsGL::f()->glUniform3fv(body_forces_program.uniform_loc("body_force"), 1, glm::value_ptr(body_force));
    ...
    void setup_grid_project(float dt) {
        ...
        GlobalsGL::f()->glUniform1f(setup_grid_project_program.uniform_loc("dt"), dt);
        GlobalsGL::f()->glUniform3fv(setup_grid_project_program.uniform_loc("bounds_min"), 1, glm::value_ptr(bounds_min));
        GlobalsGL::f()->glUniform3fv(setup_grid_project_program.uniform_loc("bounds_max"), 1, glm::value_ptr(bounds_max));
        GlobalsGL::f()->glUniform3iv(setup_grid_project_program.uniform_loc("grid_dim"), 1, glm::value_ptr(grid_dimensions));
    ...
    void pressure_update(float dt) {
        ...
        GlobalsGL::f()->glUniform1f(pressure_update_program.uniform_loc("dt"), dt);
        GlobalsGL::f()->glUniform3fv(pressure_update_program.uniform_loc("bounds_min"), 1, glm::value_ptr(bounds_min));
        GlobalsGL::f()->glUniform3fv(pressure_update_program.uniform_loc("bounds_max"), 1, glm::value_ptr(bounds_max));
        GlobalsGL::f()->glUniform3iv(pressure_update_program.uniform_loc("grid_dim"), 1, glm::value_ptr(grid_dimensions));
    ...
    void grid_to_particle() {
        ...
        GlobalsGL::f()->glUniform3fv(grid_to_particle_program.uniform_loc("bounds_min"), 1, glm::value_ptr(bounds_min));
        GlobalsGL::f()->glUniform3fv(grid_to_particle_program.uniform_loc("bounds_max"), 1, glm::value_ptr(bounds_max));
        GlobalsGL::f()->glUniform3iv(grid_to_particle_program.uniform_loc("grid_dim"), 1, glm::value_ptr(grid_dimensions));
        GlobalsGL::f()->glUniform1f(grid_to_particle_program.uniform_loc("pic_flip_blend"), pic_flip_blend);
        grid_to_particle_program.validate();
        GlobalsGL::f()->glDispatchCompute(particle_ssbo.length(), 1, 1);
    ...
    void particle_advect(float dt) {
        ...
        GlobalsGL::f()->glUniform1f(particle_advect_program.uniform_loc("dt"), dt);
        GlobalsGL::f()->glUniform3fv(particle_advect_program.uniform_loc("bounds_min"), 1, glm::value_ptr(bounds_min));
        GlobalsGL::f()->glUniform3fv(particle_advect_program.uniform_loc("bounds_max"), 1, glm::value_ptr(bounds_max));
        GlobalsGL::f()->glUniform3iv(particle_advect_program.uniform_loc("grid_dim"), 1, glm::value_ptr(grid_dimensions));
        GlobalsGL::f()->glUniform3fv(particle_advect_program.uniform_loc("eye"), 1, glm::value_ptr(eye));
        GlobalsGL::f()->glUniform3fv(particle_advect_program.uniform_loc("mouse_pos"), 1, glm::value_ptr(world_mouse_pos));
        GlobalsGL::f()->glUniform3fv(particle_advect_program.uniform_loc("mouse_vel"), 1, glm::value_ptr(world_mouse_vel));
        GlobalsGL::f()->glDispatchCompute(particle_ssbo.length(), 1, 1);
    ...
    void ssbo_barrier() {
        ...
        GlobalsGL::f()->glMemoryBarrier(GL_ALL_BARRIER_BITS);
    }
...
//         extrapolate();
    ...
    void draw_particles(const glm::mat4& projection, const glm::mat4& view, const glm::vec4& viewport) {
        program.use();
        GlobalsGL::f()->glUniformMatrix4fv(program.uniform_loc("projection"), 1, GL_FALSE, glm::value_ptr(projection));
        GlobalsGL::f()->glUniformMatrix4fv(program.uniform_loc("view"), 1, GL_FALSE, glm::value_ptr(view));
        GlobalsGL::f()->glUniform4fv(program.uniform_loc("viewport"), 1, glm::value_ptr(viewport));
        GlobalsGL::f()->glUniform3fv(program.uniform_loc("look"), 1, glm::value_ptr(look));
        vao.bind();
        GlobalsGL::f()->glDrawArraysInstanced(GL_TRIANGLE_FAN, 0, num_circle_vertices, particle_ssbo.length());
        vao.unbind();
        program.disuse();
    }
...
/*        constexpr static GLenum ssf_draw_buffers[]{GL_COLOR_ATTACHMENT0, GL_COLOR_ATTACHMENT1};
        ...
        ssf_spheres_program.use();
            ...
            GlobalsGL::f()->glUniformMatrix4fv(ssf_spheres_program.uniform_loc("projection"), 1, GL_FALSE, glm::value_ptr(projection));
            GlobalsGL::f()->glUniformMatrix4fv(ssf_spheres_program.uniform_loc("view"), 1, GL_FALSE, glm::value_ptr(view));
            GlobalsGL::f()->glUniform4fv(ssf_spheres_program.uniform_loc("viewport"), 1, glm::value_ptr(viewport));
            GlobalsGL::f()->glUniform3fv(ssf_spheres_program.uniform_loc("look"), 1, glm::value_ptr(look));

            vao.bind();
            ssf_a_texture.bind_framebuffer();

            // clear buffers
            GlobalsGL::f()->glDrawBuffers(2, ssf_draw_buffers);
            ...
            GlobalsGL::f()->glUniform1i(ssf_spheres_program.uniform_loc("pass"), 0);
            constexpr static GLenum first_pass_buffers[]{GL_COLOR_ATTACHMENT0, GL_NONE};
            GlobalsGL::f()->glDrawBuffers(2, first_pass_buffers);
            GlobalsGL::f()->glDrawArraysInstanced(GL_TRIANGLE_FAN, 0, num_circle_vertices, particle_ssbo.length());

            // sphere position pass
            glDisable(GL_BLEND);
            glEnable(GL_DEPTH_TEST);
            GlobalsGL::f()->glUniform1i(ssf_spheres_program.uniform_loc("pass"), 1);
            constexpr static GLenum second_pass_buffers[]{GL_NONE, GL_COLOR_ATTACHMENT1};
            GlobalsGL::f()->glDrawBuffers(2, second_pass_buffers);
            GlobalsGL::f()->glDrawArraysInstanced(GL_TRIANGLE_FAN, 0, num_circle_vertices, particle_ssbo.length());
        ...
        ssf_smooth_program.use();
            GlobalsGL::f()->glUniform2iv(ssf_smooth_program.uniform_loc("resolution"), 1, glm::value_ptr(resolution));
        ...
        ssf_shade_program.use();
            GlobalsGL::f()->glUniform2iv(ssf_shade_program.uniform_loc("resolution"), 1, glm::value_ptr(resolution));
            GlobalsGL::f()->glUniformMatrix4fv(ssf_shade_program.uniform_loc("projection"), 1, GL_FALSE, glm::value_ptr(projection));
            GlobalsGL::f()->glUniformMatrix4fv(ssf_shade_program.uniform_loc("inv_view"), 1, GL_FALSE, glm::value_ptr(glm::inverse(view)));
            GlobalsGL::f()->glUniform3fv(ssf_shade_program.uniform_loc("look"), 1, glm::value_ptr(look));
            GlobalsGL::f()->glUniform3fv(ssf_shade_program.uniform_loc("eye"), 1, glm::value_ptr(eye));
            glActiveTexture(GL_TEXTURE0);
    ...
    void draw_grid(const glm::mat4& projection, const glm::mat4& view, int display_mode) {
        grid_program.use();
        GlobalsGL::f()->glUniform3fv(grid_program.uniform_loc("bounds_min"), 1, glm::value_ptr(bounds_min));
        GlobalsGL::f()->glUniform3fv(grid_program.uniform_loc("bounds_max"), 1, glm::value_ptr(bounds_max));
        GlobalsGL::f()->glUniform3iv(grid_program.uniform_loc("grid_dim"), 1, glm::value_ptr(grid_dimensions));
        GlobalsGL::f()->glUniformMatrix4fv(grid_program.uniform_loc("projection"), 1, GL_FALSE, glm::value_ptr(projection));
        GlobalsGL::f()->glUniformMatrix4fv(grid_program.uniform_loc("view"), 1, GL_FALSE, glm::value_ptr(view));
        GlobalsGL::f()->glUniform1i(grid_program.uniform_loc("display_mode"), display_mode);
        grid_vao.bind();
        glPointSize(16.0);
    ...
    void draw_debug_lines(const glm::mat4& projection, const glm::mat4& view) {
        ...
        GlobalsGL::f()->glUniformMatrix4fv(debug_lines_program.uniform_loc("projection"), 1, GL_FALSE, glm::value_ptr(projection));
        GlobalsGL::f()->glUniformMatrix4fv(debug_lines_program.uniform_loc("view"), 1, GL_FALSE, glm::value_ptr(view));
