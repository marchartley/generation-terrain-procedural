...
Matrix3<float> prepareTrench(std::shared_ptr<BiomeInstance> biome, std::shared_ptr<VoxelGrid> voxelGrid) {
    ...
    Vector3 end = getSurfacePosition(voxelGrid, biome->getPointInstance(1)->position); // End
