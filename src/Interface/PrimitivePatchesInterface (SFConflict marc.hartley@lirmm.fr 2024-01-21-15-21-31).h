...
public Q_SLOTS:
    ...
    void autoGenerateDelta(const GridF &terrainSurface, const GridV3 &waterFlow, const GridV3 &surfaceNormals, const std::vector<Vector3> &availablePositions);
    void autoGenerateMotu(const GridF &terrainSurface, const GridV3 &waterFlow, const GridV3 &surfaceNormals, const std::vector<Vector3> &availablePositions);
    void autoGenerateLongShore(const GridF &terrainSurface, const GridV3 &waterFlow, const GridV3 &surfaceNormals, const std::vector<Vector3> &availablePositions);
