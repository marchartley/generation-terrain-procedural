...
public:
    ...
    void display(const Vector3& camPos = Vector3::invalid); // Nothing to display
...
public Q_SLOTS:
    ...
    void quickSaveAt(const std::string& folderName, std::string filePrefix, bool heightmap, bool voxels, bool layers);
