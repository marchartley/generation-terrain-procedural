...
public:
    ...
    void displayPressureDensities(const Vector3& camPos = Vector3::invalid());
    void displayFlows(const Vector3& camPos = Vector3::invalid());
    void displaySumOfFlows(const Vector3& camPos = Vector3::invalid());
