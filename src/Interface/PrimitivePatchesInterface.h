...
public Q_SLOTS:
    ...
    void autoGeneratePasse(const Matrix3<float>& terrainSurface, const Matrix3<Vector3>& waterFlow, const Matrix3<Vector3>& surfaceNormals, const std::vector<Vector3>& availablePositions);
    void autoGenerateDelta(const Matrix3<float> &terrainSurface, const Matrix3<Vector3> &waterFlow, const Matrix3<Vector3> &surfaceNormals, const std::vector<Vector3> &availablePositions);
    void autoGenerateMotu(const Matrix3<float> &terrainSurface, const Matrix3<Vector3> &waterFlow, const Matrix3<Vector3> &surfaceNormals, const std::vector<Vector3> &availablePositions);
    void autoGenerateLongShore(const Matrix3<float> &terrainSurface, const Matrix3<Vector3> &waterFlow, const Matrix3<Vector3> &surfaceNormals, const std::vector<Vector3> &availablePositions);

    void structureAutoGeneration();

    void updateSelectedPrimitiveItem(QListWidgetItem *current, QListWidgetItem *previous = nullptr);
